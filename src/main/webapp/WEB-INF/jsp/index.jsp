		...
		<div class="container">
			<div class="row row-padded">
				<div class="col-md-12 text-center">
					<p>这里是连接</p>
					<p><small>Powered by <a href="http://www.cssmoban.com/" target="_blank" title="waver-gallery">waver-gallery</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a> | Images by: <a href="http://pexels.com" target="_blank">Pexels</a> </small></p>
				</div>
			</div>
		</div>
	</footer>
