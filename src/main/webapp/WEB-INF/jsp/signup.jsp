...
<section id="content" class="m-t-lg wrapper-md animated fadeInDown">
    <div class="container aside-xl">
        <a class="navbar-brand block" href="index.html"><span class="h1 font-bold">Waver's Gallery</span></a>
        <section class="m-b-lg">
            ...
            <form action="index.html">
                ...
                <a href="signin.signin.jsp" class="btn btn-lg btn-info btn-block btn-rounded">Sign in</a>
            </form>
        </section>
    </div>
</section>
